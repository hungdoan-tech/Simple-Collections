package com.coreservlet.simplecrudmvc.utils;
...
public class ApplicationUtils
{
	...
	public static Connection getStroredConnection(ServletRequest request)
	{
	...
	{
		Account account = (Account) session.getAttribute(ATT_NAME_USER_NAME);
		return account;
	}
